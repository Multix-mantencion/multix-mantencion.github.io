...
(function(){
  const scripts=[
    ...
    {id:'mxWorkLogV24Loader',src:'work-log-v24.js?v=36',err:'No se pudo cargar mantenimiento y fallas v24'},
    {id:'mxDashboardFailuresV34Loader',src:'dashboard-failures-v34.js?v=37',err:'No se pudo cargar el detalle de fallas abiertas v35'}
  ];
  let i=0;
